...
--                    2017      Aidan Delaney (purescript port)
-- License     :  BSD-style (see LICENSE)
-- Maintainer  :  aidan@ontologyengineering.org
--
...
instance semigroupDeletable :: Semigroup m => Semigroup (Deletable m) where
...
instance ftorDeletable :: Functor Deletable where
  map f (Deletable i m j) = Deletable i (f m) j

instance monoidDeletable :: (Semigroup m, Monoid m) => Monoid (Deletable m) where
